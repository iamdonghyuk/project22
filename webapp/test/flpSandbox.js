		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#syncdcmmproject22-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"syncdcmmproject22-display": {
								"semanticObject": "syncdcmmproject22",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.dc.mm.project22",
									"url": sap.ui.require.toUrl("sync/dc/mm/project22")
								}
							}
						}
					}
